...
class SecimMain extends StatefulWidget {
  @override
  _SecimMainState createState() => _SecimMainState();
}


class _SecimMainState extends State<SecimMain> {
  Future<List<AnketModel>> getKategorilerVeAnketler() async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
    String unicId = sharedPreferences.getString("unicID") ?? "";
    String username = sharedPreferences.getString("username") ?? "";
                ...
                Positioned(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        print('tikladin asko');
                        //Navigator.pop(context);
                        Navigator.of(context).pushNamed('/cumhurSecimPage');
                      },
                      child:  Padding(
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      //Navigator.pop(context);
                      Navigator.of(context).pushNamed('/genelSecimPage');
                    },
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20.0),
                      child: Container(
